...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        wall.path = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 405, height: 650)).cgPath
        wall.position = CGPoint(x: view.scene!.frame.minX + 5, y: view.scene!.frame.minY + 83)
        wall.lineWidth = 3
        wall.strokeColor = UIColor.red
        wall.name = "wall"
        self.addChild(wall)
